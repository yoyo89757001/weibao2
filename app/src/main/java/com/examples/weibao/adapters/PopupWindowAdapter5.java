...
public class PopupWindowAdapter5 extends BaseAdapter {

    private LayoutInflater mInflater;//得到一个LayoutInfalter对象用来导入布局
    private List<XuanZeBean> fuWuQiBeanList;


    /*构造函数*/
    public PopupWindowAdapter5(Context context, List<XuanZeBean> fuWuQiBeanList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.title.setText(fuWuQiBeanList.get(position).getS());
