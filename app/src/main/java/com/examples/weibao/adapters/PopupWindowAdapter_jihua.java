...
public class PopupWindowAdapter_jihua extends BaseAdapter {
    ...
    /*构造函数*/
    public PopupWindowAdapter_jihua(Context context, List<PlansBean> fuWuQiBeanList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.title.setText(fuWuQiBeanList.get(position).getArea()+fuWuQiBeanList.get(position).getPlanMonth()+"月份计划");
