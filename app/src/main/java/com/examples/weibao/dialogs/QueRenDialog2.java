 ...
 * @author Tom.Cai
 */
public class QueRenDialog2 extends Dialog {

    private Button positiveButton,quxiao;
    private TextView shuoming;
   // private View quxiao_v;
    public QueRenDialog2(Context context) {
        super(context, R.style.dialog_style2);
        setCustomDialog();
    }

    private void setCustomDialog() {
        View mView = LayoutInflater.from(getContext()).inflate(R.layout.queren333, null);
